...
public class MainActivity extends AppCompatActivity {
    ...
    private void translateText(){
        ...
        if (english_word.contains(word)){
            ...
            translation_message ="Translation of : "+word;
            ...
            translation_message = "The translationn: "+word;
            for (int i = 0; i < kiswahili_words.size(); i++) {
                if (kiswahili_words.get(i).equals(word))
                    words.add(english_word.get(i));
            }
        }else {
            translation_message = "word not available make sure you write words in the dictionary or kamusi";
        }
